<template>
  <div class="flex justify-center items-center">
    ...
    <div class="w-full md:w-1/2">
      <div class="flex-1 pr-12 space-y-4 md:space-y-0">
        <div class="py-8 pl-8 md:py-[30px] md:pl-[28px] flex rounded-lg items-center shadow-lg hover:shadow-purple-200">
          <div class="w-16 md:w-24 h-16 md:h-24 bg-primary rounded-md justify-center items-center hidden md:flex">
            <p class="text-2xl md:text-3xl font-bold text-white text-center">WD</p>
          </div>
          <div class="ml-4">
            <p class="font-bold text-xl md:text-2xl pb-2">Web UI/UX Design</p>
            <p>Creative and out of this world designs.</p>
          </div>
        </div>
        <div class="py-8 pl-8 md:py-[30px] md:pl-[28px] flex rounded-lg items-center shadow-lg hover:shadow-purple-200">
          <div class="w-16 md:w-24 h-16 md:h-24 bg-primary rounded-md justify-center items-center hidden md:flex">
            <p class="text-2xl md:text-3xl font-bold text-white text-center">MD</p>
          </div>
          <div class="ml-4">
            <p class="font-bold text-xl md:text-2xl pb-2">Mobile App UI/UX Design</p>
            <p>Easy to use and beautiful design that achieve the purpose.</p>
          </div>
        </div>
        <div class="py-8 pl-8 md:py-[30px] md:pl-[28px] flex rounded-lg items-center shadow-lg hover:shadow-purple-200">
          <div class="w-16 md:w-24 h-16 md:h-24 bg-primary rounded-md justify-center items-center hidden md:flex">
            <p class="text-2xl md:text-3xl font-bold text-white text-center">AD</p>
          </div>
          <div class="ml-4">
            <p class="font-bold text-xl md:text-2xl pb-2">Analytical Dashboards UI/UX Design</p>
            <p>Accurate and feature-packed analytical designs.</p>
          </div>
        </div>
      </div>
    </div>
